...
public class ClusterLinkConfigs {
    ...
    public static final String CLUSTER_LINK_METADATA_LOG_SUB_DIR_CONFIG = CLUSTER_LINK_PREFIX + "metadata.log.sub.dir";
    public static final String CLUSTER_LINK_METADATA_LOG_SUB_DIR_DEFAULT = "source-link";
    public static final String CLUSTER_LINK_METADATA_LOG_SUB_DIR_DOC = "Sub directory in metadata log directory where to store metadata of source quorum cluster";
    ...
    public String metadataLogSubDir() {
    	return metadataLogSubDir;
    }
